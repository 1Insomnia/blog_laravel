...
@section('content')
    <section>
        <div class="container mx-auto px-5">
            <div class='flex  my-10 bg-white shadow-md rounded-lg overflow-hidden mx-auto'>
                <div class='flex items-center w-full'>
                    <div class='w-full'>
                        <div class="
                flex flex-row mt-2 px-2 py-3 mx-3">
                        ...
                        @endif
                        {{-- Post Title --}}
                        <h1 class='mt-4 text-gray-600 font-semibold text-lg mb-2 mx-3 px-2'>
                            {{ $post->title }}
                        </h1>
                        <div class='text-gray-500 font-thin text-base mb-6 mx-3 px-2'>
                            {{ $post->body }}
                        </div>
