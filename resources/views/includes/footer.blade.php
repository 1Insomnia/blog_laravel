<footer class=" pt-6 md:pt-12 lg:pt-24" id="footer">
    <div class="border-t border-gray-300 flex flex-col items-center space-y-6 px-5 py-12 md:flex-row md:space-y-0">
        ...
        <div class="block flex-1 text-right">
            <a class="inline-block hover:text-accent" href="">Contact Me</a>
            <a class="inline-block ml-4 hover:text-accent" href="">Privacy & Terms</a>
        </div>
    </div>
</footer>
